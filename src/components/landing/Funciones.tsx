  ...
  return (
    <section id="funciones" className="bg-cream">
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 md:py-20">
        <h2 className="max-w-3xl font-display text-3xl font-extrabold tracking-tight text-balance sm:text-4xl md:text-5xl">
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          <article className="rounded-3xl bg-primary p-6 text-primary-foreground sm:p-7">
            ...
            <h3 className="mt-4 font-display text-xl font-bold">Diagnóstico Inteligente</h3>
          ...
          <article className="rounded-3xl border border-border bg-card p-6 sm:p-7">
            ...
            <h3 className="mt-4 font-display text-xl font-bold">Traductor de Conductas</h3>
          ...
          <article className="rounded-3xl bg-wine p-6 text-wine-foreground sm:p-7">
            ...
            <h3 className="mt-4 font-display text-xl font-bold">Analizador de Video</h3>
          ...
          <article className="overflow-hidden rounded-3xl bg-accent text-accent-foreground md:col-span-2">
            <div className="grid gap-0 sm:grid-cols-[minmax(0,1fr)_40%]">
              <div className="p-6 sm:p-7">
                ...
                <h3 className="mt-4 font-display text-xl font-bold">Modo Cachorro</h3>
                <p className="mt-2 text-base">
          ...
          <article className="overflow-hidden rounded-3xl border border-border bg-card">
            ...
            <div className="p-6 sm:p-7">
              ...
              <h3 className="mt-4 font-display text-xl font-bold">Modo Perro Adulto</h3>
          ...
          <article className="rounded-3xl border border-border bg-secondary p-6 text-secondary-foreground sm:p-7">
            ...
            <h3 className="mt-4 font-display text-xl font-bold">Predictor de Higiene</h3>
            <p className="mt-2 text-base">
          ...
          <article className="rounded-3xl bg-primary p-6 text-primary-foreground sm:p-7">
            ...
            <h3 className="mt-4 font-display text-xl font-bold">Asistente IA 24/7</h3>
            <p className="mt-2 text-base">
